...
@bot.event
async def on_ready():
    await bot.change_presence(activity = discord.Streaming(name="Gmail Spam Demo", url="https://www.twitch.tv/gmail"))
    type(f""""{Fore.RED}
    ███████╗███╗   ███╗ █████╗ ██╗██╗         
    ██╔════╝████╗ ████║██╔══██╗██║██║         
    █████╗  ██╔████╔██║███████║██║██║         
...
async def email(ctx,count=None,bomb_email=None,*,message=None):
    ...
    if x > 100:
        ...
        counting = int(0)
        embed=discord.Embed(title=f"{counting}/{count}", url="https://github.com/kieronia", color=0xff0000)
        embed.set_author(name="Email sent!", url="https://github.com/kieronia")
        ...
        embed=discord.Embed(title="Please consider following!", url="https://github.com/kieronia", color=0xff0000)
        embed.set_author(name="Done spamming!", url="https://github.com/kieronia")
        embed.set_thumbnail(url="https://cdn.iconscout.com/icon/free/png-256/gmail-30-722694.png")
        await msg.edit(embed=embed)
